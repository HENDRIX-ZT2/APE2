...
class WikipediaPage(object):
	...
	def __load(self, redirect=True, preload=False):
		...
		#http://stackoverflow.com/questions/10634278/get-the-first-link-in-a-wikipedia-article-not-inside-parentheses
		#here it is already queried without brackets!
		#print(query['pages'].values())
